<script lang="ts">
	...
	let sliders: Slider[] = [
		new Slider(
			...
			defaultForceAtlasSettings.gravity as number,
			{
				min: 0.00001,
				max: 10,
				precision: 5,
		...
		new Slider(
			...
			defaultForceAtlasSettings.repulsion as number,
			{
				min: 0.0001,
				max: 10,
				precision: 5,
		...
		new Slider(
			...
			defaultForceAtlasSettings.attraction as number,
			{
				min: 0.000001,
				max: 0.1,
				precision: 8,
		...
		new Slider(
			...
			defaultForceAtlasSettings.inertia as number,
			{
				min: 0,
				max: 5,
				precision: 1,
		...
		new Slider(
			...
			defaultForceAtlasSettings.maxMove as number,
			{
				min: 0,
				max: 10,
				precision: 1,
